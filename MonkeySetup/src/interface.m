...
if get(handles.toggleEMG, 'Value')
    expData.experiment.expType = 'EMG';
elseif get(handles.toggleDyno, 'Value')
    expData.experiment.expType = 'Dyno';
elseif get(handles.toggleImplant, 'Value')
    expData.experiment.expType = 'Implant';
elseif get(handles.toggleEMGDyno, 'Value')
    expData.experiment.expType = 'EMG+Dyno';
end
...
switch exp.expType
    case 'EMG+Dyno'
        set(handles.toggleEMG, 'Value', 1)
        set(handles.toggleDyno, 'Value', 1)
        set(handles.toggleImplant, 'Value', 0)
        
    case 'EMG'
        set(handles.toggleEMG, 'Value', 1)
        set(handles.toggleDyno, 'Value', 0)
        set(handles.toggleImplant, 'Value', 0)
        
    case 'Dyno'
        set(handles.toggleEMG, 'Value', 0)
        set(handles.toggleDyno, 'Value', 1)
        set(handles.toggleImplant, 'Value', 0)
    ...
    case 'Implant'
        set(handles.toggleEMG, 'Value', 0)
        set(handles.toggleDyno, 'Value', 0)
        set(handles.toggleImplant, 'Value', 1)
end
